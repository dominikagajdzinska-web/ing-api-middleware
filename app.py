...
def get_access_token():
    """Pobiera token dostępu z ING Sandbox."""
    data = {
    ...
    try:
        ...
        print("TOKEN RESPONSE:", r.status_code, r.text)  # log do debugowania
        r.raise_for_status()
...
def get_accounts():
    try:
        ...
        try:
            ...
            response_json = {"error": "Response is not JSON", "content": r.text}
        return jsonify(response_json), r.status_code
    except requests.exceptions.RequestException as e:
